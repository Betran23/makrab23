...
const divisions: DivisionData[] = [
  ...
  },
  {
    ...
    description:
      "Divisi KESI bertanggung jawab dalam memastikan kebutuhan konsumsi peserta dan panitia terpenuhi, serta menjaga kesiapan kesehatan selama kegiatan berlangsung. Divisi ini memastikan peserta tetap aman, nyaman, dan bertenaga selama acara.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export default function DivisionInfo() {
  ...
  return (
    <section
      id="divisi"
      className="py-20 px-4 sm:px-6 lg:px-8 bg-[var(--color-warm-white)]"
    >
          ...
          {divisions.map((division, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Subtitle */}
                <p
                  className={`${colors.text} font-[family-name:var(--font-lora)] text-sm font-semibold mb-4`}
                >
                  {division.subtitle}
                </p>
